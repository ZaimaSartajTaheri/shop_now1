...
{
$sql=mysqli_query($con,"SELECT password FROM  admins where password='".md5($_POST['password'])."' && username='".$_SESSION['alogin']."'");
$num=mysqli_fetch_array($sql);
if($num>0)
{
 $con=mysqli_query($con,"update admins set password='".md5($_POST['newpassword'])."', updationDate='$currentTime' where username='".$_SESSION['alogin']."'");
...
{?>
                                ...
                                <form class="form-horizontal row-fluid" name="chngpwd" method="post"
                                    ...
                                    <div class="control-group">
                                        <div class="controls">
                                            <button type="submit" name="submit" class="btn lnk">Submit</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
